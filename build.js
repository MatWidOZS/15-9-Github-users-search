	...
	_createClass(App, [{
		...
		value: function render() {
			...
			return React.createElement(
				...
				React.createElement(UsresList, { users: this.state.users })
			);
		}
	}]);
...
var UsresList = function (_React$Component2) {
	_inherits(UsresList, _React$Component2);

	function UsresList() {
		_classCallCheck(this, UsresList);

		return _possibleConstructorReturn(this, (UsresList.__proto__ || Object.getPrototypeOf(UsresList)).apply(this, arguments));
	}

	_createClass(UsresList, [{
		key: "render",
		value: function render() {
			return React.createElement(
				"div",
